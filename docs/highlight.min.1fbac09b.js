...
!function (e) {
    ...
    !function t(r, e) {
      if (!r.compiled) {
        if (r.compiled = !0, r.k = r.k || r.bK, r.k) {
          ...
          var n = {};
          "string" == typeof r.k ? _a("keyword", r.k) : o(r.k).forEach(function (e) {
            _a(e, r.k[e]);
          }), r.k = n;
        }
  ...
  function k(e, t, i, r) {
    ...
    function s() {
      b += null != u.sL ? function () {
        ...
        for (a = "", t = 0, u.lR.lastIndex = 0, r = u.lR.exec(p); r;) {
          a += y(p.substring(t, r.index)), n = u, i = r, void 0, s = l.cI ? i[0].toLowerCase() : i[0], (e = n.k.hasOwnProperty(s) && n.k[s]) ? (m += e[1], a += c(e[0], y(r[0]))) : a += y(r[0]), t = u.lR.lastIndex, r = u.lR.exec(p);
        }
    ...
    function o(e) {
      b += e.cN ? c(e.cN, "", !0) : "", u = Object.create(e, {
        parent: {
          value: u
        }
      });
    ...
    function a(e, t) {
      ...
      var r = function (e, t) {
        ...
        for (r = 0, a = t.c.length; r < a; r++) {
          if (w(t.c[r].bR, e)) return t.c[r].endSameAsBegin && (t.c[r].eR = (n = t.c[r].bR.exec(e)[0], new RegExp(n.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&"), "m"))), t.c[r];
        }
      }(t, u);
